/*
    CloudShell4 Unauthorized Copyright 2020,2021,2022,2023,2024 Edward A. Kisiel hominoid @ cablemi.com
    ...
    20241014 Version 2.1.0  added Cloudshell4, Cloudshell4-XL for h4, h4+, h4_ultra

                            cs4_top(sbc_model, style)
                            cs4_io(sbc_model, style)
                            cs4_deck(sbc_model, style)
                            cs4_front(sbc_model, style)
...
adjust = .01;
$fn=90;
spacer=[5.75,43,3.4,7.5,3,0,0,1,0,4.2,4];
// case wall thickness
wallthick = 3; // [3,5]
...
// platter view
if (view == "platter") {
    if(case_style == "Cloudshell2" && sbc_model != "h3" && sbc_model != "h2" && sbc_model != "m1") {
    ...
    if(case_style == "Cloudshell4-MiniXS" && sbc_model == "m1") {
        ...
        translate([240,110,0]) 
            ...
            if(back_fan == "dual 40mm") { 
                translate([120,110,0])
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan40x2_Mini.dxf");
            }
            else {
                translate([120,110,0])
    ...
    if(case_style == "Cloudshell4-MiniXS"  && (sbc_model == "h3" || sbc_model == "h2")) {
        ...
        translate([120,55,0]) cs4_deck(sbc_model,case_style);
        translate([240,100,sidethick]) rotate([180,0,0])
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h3_MiniXS.dxf");
        translate([240,110,0]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h3_MiniXS.dxf");
        difference() {
        translate([120,110,0])
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h3_MiniXS.dxf");
            translate([129,106,adjust])vent_hex(19, 2, 4, 7.5, 2, "portrait");
            }
        translate([130,180,0])
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Key_Mini.dxf");
        translate([150,240,0]) hdd35_25holder(100,111);
        translate([0,240,0]) hdd35_25holder(136,111);
    ...
    if(case_style == "Cloudshell4") {
        ...
        if(sbc_model != "n2+" && sbc_model != "n2" && sbc_model != "m1") {
            translate([-20,110,0]) rotate([180,0,0]) cs4_top(sbc_model,case_style);
        ...
        if(sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra") {
            translate([260,140,sidethick]) rotate([180,0,0])
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h4.dxf");
            translate([260,160,0]) 
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h4.dxf");  
            translate([125,150,0])
                linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h4.dxf");
            translate([0,275,0]) hdd35_25holder(188,121);
            translate([195,280,0]) rotate([-90,0,0]) cableholder_spacer();
            translate([210,280,0]) rotate([-90,0,0]) cableholder_spacer();
            translate([225,280,0]) rotate([-90,0,0]) cableholder_spacer();
            if(h3_port_extender == "remote") {
        ...
        if(sbc_model != "h3" && sbc_model != "h2" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {        
            translate([240,140,sidethick]) rotate([180,0,0])
    ...
    if(sbc_model == "m1" && (case_style == "Cloudshell4-XL" || case_style== "Cloudshell4-XXL")) {
            ...
            if(back_fan == "dual 80mm") {
                translate([120,150,0]) 
                    difference() {
                        ...
                        translate([10,-9,0]) fan_mask(80,3,"fan_hex");
                        translate([10,70,0]) fan_mask(80,3,"fan_hex");
                    }
            }
            else {
                translate([120,150,0])
            ...
            if(back_fan == "dual 80mm") {
                translate([120,150,0]) 
                    difference() {
                        ...
                        translate([10,10,0]) fan_mask(80,3,"fan_hex");
                        translate([10,100,0]) fan_mask(80,3,"fan_hex");
                    }
            }
            else {
                translate([120,150,0])
    ...
    if(case_style == "Cloudshell4-XL" && (sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra")) {
        translate([-20,110,0]) rotate([180,0,0]) cs4_top(sbc_model,case_style);
        translate([100.95,125,0]) rotate([0,180,0]) cs4_front(sbc_model,case_style);
        translate([120,0,-5]) cs4_io(sbc_model,case_style);
        translate([120,55,0]) cs4_deck(sbc_model,case_style);
        translate([260,140,sidethick]) rotate([180,0,0])
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h4_XL.dxf");
        translate([260,160,0]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h4_XL.dxf");  
        translate([125,150,0])
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h4_XL.dxf");
        translate([0,325,0]) hdd35_25holder(188,121);
        translate([195,300,0]) rotate([-90,0,0]) cableholder_spacer();
        translate([210,300,0]) rotate([-90,0,0]) cableholder_spacer();
        translate([225,300,0]) rotate([-90,0,0]) cableholder_spacer();
        if(h3_port_extender == "remote") {
            translate([150,255,30]) rotate([0,180,90]) h3_port_extender_holder("top",wallthick);
            translate([185,255,-2.5]) rotate([0,0,90]) h3_port_extender_holder("bottom",wallthick);
        }
...
if (view == "model") {
    ...
    if(case_style == "Cloudshell4-MiniXS" && (sbc_model == "h3" || sbc_model == "h2")) {
        translate([sidethick+110,139,35]) rotate([0,0,180]) sbc(sbc_model);
        color("grey",.8) translate([-.5,0,0]) rotate([90,0,90]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h3_MiniXS.dxf");
        color("grey",.8) translate([110.5+sidethick,0,0]) rotate([90,0,90]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h3_MiniXS.dxf");
        color("grey",.6) translate([110+(sidethick+.5),140,26]) rotate([90,0,180]) 
            cs4_io(sbc_model, case_style);
        color("lightgrey",.6) translate([sidethick-.5,135.25,31.25]) cs4_deck(sbc_model, case_style);
        difference() {
            color("lightgrey",.6) translate([sidethick,153.5,10.75]) rotate([90,0,0]) 
                linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h3_MiniXS.dxf");
                color("lightgrey",.6) translate([12,153,6]) rotate([90,0,0]) vent_hex(19, 2, 4, 7.5, 2, "portrait");
            }
        color("lightgrey",.6) translate([sidethick-.5,5,77]) cs4_top(sbc_model, case_style);
        color("lightgrey",.7) translate([sidethick-.5,8,5]) rotate([90,0,0]) cs4_front(sbc_model, case_style);
        // upper 2.5 hdd
//        color("white",1) translate([sidethick+110,10,12.5]) rotate([0,0,90]) hdd35_25holder(100,111);
//        translate([sidethick+89.4,12,16.5]) rotate([0,0,90]) hd25(7);
        // lower 2.5 hdd
        color("white",1) translate([sidethick+110,10,0]) rotate([0,0,90]) hdd35_25holder(136,111);
        translate([sidethick+89.4,12,4]) rotate([0,0,90]) hd25(15);
        if(h3_port_extender == "remote") {
            translate([77.5,15,38]) rotate([0,0,90]) h3_port_extender("remote");
            translate([77.5,15,38]) rotate([0,0,90]) h3_port_extender_holder("both",3);
            }
        if(h3_power_button == true) {
            translate([23,19.5,80]) hk_pwr_button();
        }
    }
    // cloudshell4-mini
    if(case_style == "Cloudshell4-Mini") {
        ...
        if(sbc_model != "h3"  && sbc_model != "h2" && sbc_model != "m1" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
...
//            color("lightgrey",1) translate([sidethick+110,10,0]) rotate([0,0,90]) hdd35_25holder(188,111);
    ...
    if(case_style == "Cloudshell4-MiniXL") {
        ...
        if(sbc_model != "h2" && sbc_model != "h3" && sbc_model != "m1" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
            translate([sidethick+4.5,114,84]) rotate([180,0,0]) sbc(sbc_model);       
            color("white",.1) translate([-.5,0,0]) rotate([90,0,90]) 
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_MiniXL.dxf");
            color("white",.1) translate([100.5+sidethick,0,0]) rotate([90,0,90]) 
    ...
    if(case_style == "Cloudshell4") {
        ...
        if(sbc_model == "h3"  || sbc_model == "h2") {
            ...
            color("lightgrey",.7) translate([sidethick-.5,8,5]) rotate([90,0,0]) cs4_front(sbc_model, case_style);
            // bottom
            color("lightgrey",1) translate([sidethick+sbc_width,10,0]) rotate([0,0,90]) 
                hdd35_25holder(188,sbc_width+1);
            color("darkgrey",1) translate([wallthick+9.4,26.5,24]) rotate([0,0,180]) cableholder_spacer();
            color("darkgrey",1) translate([wallthick+9.4,86.5,24]) rotate([0,0,180]) cableholder_spacer();
            color("darkgrey",1) translate([wallthick+9.4,128.5,24]) rotate([0,0,180]) cableholder_spacer();
        ...
        if(sbc_model == "h4"  || sbc_model == "h4+"  || sbc_model == "h4_ultra") {
            sbc_width = 120;
            translate([sidethick+sbc_width,149,107]) rotate([0,0,180]) sbc(sbc_model);
            color("grey",.8) translate([-.5,0,0]) rotate([90,0,90]) 
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h4.dxf");
            color("grey",.8) translate([sbc_width+.5+sidethick,0,0]) rotate([90,0,90]) 
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h4.dxf");
            color("grey",.6) translate([sbc_width+(sidethick+.5),150,98]) rotate([90,0,180]) 
                cs4_io(sbc_model, case_style);
            color("lightgrey",.6) translate([sidethick-.5,125.25,103.25]) cs4_deck(sbc_model, case_style);
            color("lightgrey",.6) translate([sidethick,203.5,10.75]) rotate([90,0,0]) 
                linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h4.dxf");
        ...
        if(sbc_model != "m1" && sbc_model != "h2" && sbc_model != "h3" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
        ...
        if(sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra" && sbc_model != "h3" && sbc_model != "h2") {
            // upper 3.5 hdd
    ...
    if(case_style == "Cloudshell4-XL" && (sbc_model == "h4"  || sbc_model == "h4+"  || sbc_model == "h4_ultra")) {
        sbc_width = 120;
        translate([sidethick+sbc_width,149,150]) rotate([0,0,180]) sbc(sbc_model);
        color("grey",.8) translate([-.5,0,0]) rotate([90,0,90]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h4_XL.dxf");
        color("grey",.8) translate([sbc_width+.5+sidethick,0,0]) rotate([90,0,90]) 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h4_XL.dxf");
        color("grey",.6) translate([sbc_width+(sidethick+.5),150,141]) rotate([90,0,180]) 
            cs4_io(sbc_model, case_style);
        color("lightgrey",.6) translate([sidethick-.5,125.25,146.25]) cs4_deck(sbc_model, case_style);
        color("lightgrey",.6) translate([sidethick,203.5,10.75]) rotate([90,0,0]) 
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h4_XL.dxf");
        color("lightgrey",.6) translate([sidethick-.5,5,192]) cs4_top(sbc_model, case_style);
        color("lightgrey",.7) translate([sidethick-.5,8,5]) rotate([90,0,0]) cs4_front(sbc_model, case_style);
        // bottom
        color("lightgrey",1) translate([sidethick+sbc_width,10,0]) rotate([0,0,90]) 
            hdd35_25holder(188,sbc_width+1);
        ...
        color("darkgrey",1) translate([wallthick+9.4,86.5,24]) rotate([0,0,180]) cableholder_spacer();
        color("darkgrey",1) translate([wallthick+9.4,128.5,24]) rotate([0,0,180]) cableholder_spacer();
        color("darkgrey",1) translate([wallthick+9.4,26.5,56]) rotate([0,0,180]) cableholder_spacer();
        color("darkgrey",1) translate([wallthick+9.4,86.5,56]) rotate([0,0,180]) cableholder_spacer();
        color("darkgrey",1) translate([wallthick+9.4,128.5,56]) rotate([0,0,180]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,26.5,24]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,86.5,24]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,128.5,24]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,26.5,56]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,86.5,56]) cableholder_spacer();
        color("darkgrey",1) translate([sbc_width-6,128.5,56]) cableholder_spacer();
        if(h3_port_extender == "remote") {
            translate([77.5,15,153]) rotate([0,0,90]) h3_port_extender("remote");
            translate([77.5,15,153]) rotate([0,0,90]) h3_port_extender_holder("both",3);
            }
        if(h3_power_button == true) {
            translate([23,19.5,195]) hk_pwr_button();
        }
        // 3.5 hdd
        translate([sidethick+111,10,113.5]) rotate([0,0,90]) hd35();
        translate([sidethick+111,10,81.5]) rotate([0,0,90]) hd35();
        translate([sidethick+111,10,49.5]) rotate([0,0,90]) hd35();
        translate([sidethick+111,10,17.5]) rotate([0,0,90]) hd35();
    } 
    // Cloudshell4-XXL  
...
if (view == "part") {
    ...
    if(case_style == "Cloudshell4-MiniXS" && (sbc_model == "h3" || sbc_model == "h2")) {
        ...
        difference() {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h3_MiniXS.dxf");
            translate([9,-4,adjust])vent_hex(19, 2, 4, 7.5, 2, "portrait");
            }
        }
        if(individual_part == "accessories") {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Key_Mini.dxf");
        ...
        if(individual_part == "bottom") {
            translate([0,0,0]) hdd35_25holder(136,111);
            translate([0,120,0]) hdd35_25holder(100,111);
        }
    }    
    if(case_style == "Cloudshell4-Mini") {
        if(sbc_model == "n2+"  || sbc_model == "n2" || sbc_model == "m1") {
    ...
    if(case_style == "Cloudshell4-MiniXL") {
        ...
        if(sbc_model != "n2+"  && sbc_model != "n2" && sbc_model != "m1" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
            if(individual_part == "top") {
                translate([0,110,0]) rotate([180,0,0]) cs4_top(sbc_model,case_style);
            }
            if(individual_part == "front") {
        ...
        if(individual_part == "right" && (sbc_model != "h3" && sbc_model != "h2" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra")) {        
            translate([0,100,sidethick]) rotate([180,0,0])
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h3_MiniXL.dxf");
        }
        ...
        if(individual_part == "left" && sbc_model != "h3" && sbc_model != "h2" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") { 
            linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_MiniXL.dxf");
        }
        ...
        if(individual_part == "rear" && sbc_model != "h3" && sbc_model != "h2" && back_fan == "40mm") {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_Mini.dxf");
        }
        if(individual_part == "rear" && sbc_model != "h3" && sbc_model != "h2" && back_fan == "dual 40mm") {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan40x2_Mini.dxf");
        }
        if(individual_part == "accessories") {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Key_Mini.dxf");
        ...
        if(individual_part == "bottom" && sbc_model != "h3" && sbc_model != "h2" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
    ...
    if(case_style == "Cloudshell4") {
        ...
        if(individual_part == "right" && (sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra")) {
            translate([0,0,sidethick]) rotate([0,0,0])
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide_h4.dxf");
        }
        if(individual_part == "right" && sbc_model != "h2" && sbc_model != "h3" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
            translate([0,0,sidethick]) rotate([0,0,0])
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_RightSide.dxf");
        }
        if(individual_part == "left" && (sbc_model == "h3" || sbc_model == "h2")) {
        ...
        if(individual_part == "left" && (sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra")) {
            translate([0,155,sidethick]) rotate([180,0,0])
                linear_extrude(height = sidethick) import(file = "./dxf/CloudShell4_LeftSide_h4.dxf");
        }
        if(individual_part == "left" && sbc_model != "h2" && sbc_model != "h3" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
        ...
        if(individual_part == "rear" && ((sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra"))) {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan_h4.dxf");
        }
        if(individual_part == "rear" && sbc_model != "h2" && sbc_model != "h3" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearFan.dxf");
        }
        if(individual_part == "accessories") {        
            linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Key_Mini.dxf");
        ...
        if(individual_part == "bottom" && (sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra")) {        
                hdd35_25holder(188,121);
        }
        if(individual_part == "bottom" && sbc_model != "h2" && sbc_model != "h3" && sbc_model != "h4" && sbc_model != "h4+" && sbc_model != "h4_ultra") {        
                hdd35_25holder(173);
        }
    }
    if(case_style == "Cloudshell4-XL" && (sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra")) {
        ...
        difference() {
            union() {
                if(case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" || 
                        case_style == "Cloudshell4-Mini" || case_style == "Cloudshell4-MiniXS") {
            ...
            if(h3_standoffs == true && (case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" 
                    || case_style == "Cloudshell4-Mini" || case_style == "Cloudshell4-MiniXS")) {
                translate([106.75,27.75,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([4.5,27.75,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([106.75,116.25,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([4.5,109.25,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
            }
            if(top_fan == "40mm") {
                translate([35.5,55,0]) fan_mask(40, wallthick, "fan_hex");
                // wire access
//                translate([110,90,-adjust]) cylinder(d=4, h=wallthick+(adjust*2));                        
//                translate([60,85,-adjust]) cylinder(d=5, h=wallthick+(adjust*2));                        
            }
            if(top_fan == "60mm") {
                translate([26,45,0]) fan_mask(60, wallthick, "fan_hex");
                // wire access
                translate([110,100,-adjust]) cylinder(d=5, h=wallthick+(adjust*2));                        
//                translate([60,9,-adjust]) cylinder(d=4, h=wallthick+(adjust*2));                        
            }
            if(top_fan == "80mm") {
                translate([20.5,30,0]) fan_mask(80, wallthick, "fan_hex");
                // wire access
                translate([110,122,-adjust]) cylinder(d=5, h=wallthick+(adjust*2));                        
            }
             if(top_fan == "92mm") {
                translate([9.5,30,0]) fan_mask(92, wallthick, "fan_hex");
                // wire access
                translate([110,122,-adjust]) cylinder(d=5, h=wallthick+(adjust*2));                        
            }
             if(top_fan == "hex vent") {
        ...
        if(h3_standoffs == true && (case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" 
            ...
            if(h3_port_extender == "remote") {
                difference() {
                    translate([106.75,27.75,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
            ...
            translate([4.5,27.75,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
            translate([106.75,116.25,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
            translate([4.5,109.25,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
        }
    }
    if(sbc_model == "h4"  || sbc_model == "h4+"  || sbc_model == "h4_ultra") {
        difference() {
            union() {
                if(case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" || 
                        case_style == "Cloudshell4-XL") {
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Top_h4.dxf");
                }
            }
            if(h3_standoffs == true && (case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" 
                    || case_style == "Cloudshell4-XL")) {
                translate([116.75,27.75,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([4.5,27.75,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([116.75,126.25,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
                translate([14.5,119.25,wallthick-(wallthick+adjust)+adjust]) cylinder(d=6.25, h=wallthick+2*adjust);
            }
            if(top_fan == "40mm") {
                translate([35.5,55,0]) fan_mask(40, wallthick, "fan_hex");
                // wire access
...
//                translate([60,9,-adjust]) cylinder(d=4, h=wallthick+(adjust*2));                        
            ...
            if(top_fan == "80mm") {
             ...
             if(top_fan == "hex vent") {
                translate([14,30,adjust]) vent_hex(19, 9, 4, 7.5, 2, "landscape");
            }
            if(vu5_front == true) {
                translate([8,wallthick,-adjust]) cube([6,8,wallthick+(adjust*2)]);
                translate([86.5,wallthick,-adjust]) cube([6,8,wallthick+(adjust*2)]);
        ...
        if(h3_standoffs == true && (case_style == "Cloudshell4" || case_style == "Cloudshell4-MiniXL" 
            ...
            if(h3_port_extender == "remote") {
                difference() {
                    translate([116.75,27.75,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
                    translate([102,29.25,wallthick-2*adjust-43]) cube([12,3,25]);
                }
            }
            else {
            ...
            translate([4.5,27.75,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
            translate([116.75,126.25,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
            translate([14.5,119.25,wallthick-adjust]) rotate([0,0,30]) standoff(spacer);
        }
    }
}
...
module cs4_io(sbc_model,style) {
        ...
        if(sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra") {
              linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_ioPlate_h4.dxf");    
        }
    }
...
module cs4_deck(sbc_model,style) {
        ...
        if(sbc_model == "h3"  || sbc_model == "h2") {
            ...
            if(case_style == "Cloudshell4-Mini" || case_style == "Cloudshell4-MiniXS") {
                linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearDeck_h3_Mini.dxf");
            }
        }
        if(sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra") {
            if(case_style == "Cloudshell4" || case_style == "Cloudshell4-XL" || case_style == "Cloudshell4-MiniXL") {
                difference() {
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_RearDeck_h4.dxf");
                    if(deck_vent == "hex vent") {
                        translate([14,25,adjust]) vent_hex(19, 5, 4, 7.5, 2, "portrait");
                    }
                }  
            }
        }
...
module cs4_front(sbc_model,style) {
        ...
        if(sbc_model == "h3" || sbc_model == "h2") {
            ...
            if(case_style == "Cloudshell4-MiniXS") {
                difference() {
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Front_h3_MiniXS.dxf");
                    // front port extender opening
                    if(h3_port_extender == "remote") {
                        translate([75,33,-9]) rotate([0,90,90]) h3_port_extender("remote",true);
                    }
                    if(front_vent == "hex vent") {
                        translate([9,5,adjust]) vent_hex(19, 3, 4, 7.5, 2, "portrait");
                    }
                }
            }
        }            
        if(sbc_model == "h4" || sbc_model == "h4+" || sbc_model == "h4_ultra") {
            if(case_style == "Cloudshell4") {
                difference() {
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Front_h4.dxf");
                    if(front_vent == "hex vent") {
                        translate([14,10,adjust]) vent_hex(19, 11, 4, 7.5, 2, "portrait");
                    }
                }
            }
            if(case_style == "Cloudshell4-XL") {
                difference() {
                    linear_extrude(height = wallthick) import(file = "./dxf/CloudShell4_Front_h4_XL.dxf");
                    if(front_vent == "hex vent") {
                        translate([14,10,adjust]) vent_hex(19, 15, 4, 7.5, 2, "portrait");
                    }
                }
            }
        }
